data.raw["unit-spawner"]["bob-biter-spawner"].result_units = (function()
                     local res = {}
                       ...
                       res[8] = {"big-biter-Mk2",		 {{0.70, 0.0}, {1.00, 0.1}}}
					   res[9] = {"big-biter-Mk3", 		 {{0.80, 0.0}, {1.00, 0.1}}}

					   res[10] = {"bob-bigger-biter",  	{{0.70, 0.0}, {0.90, 0.3}}}		
					   res[11] = {"bob-biggest-biter",	{{0.90, 0.0}, {1.00, 0.3}}}		
					   res[12] = {"bob-fire-biter",  	{{0.90, 0.0}, {1.00, 0.2}}}		
					   
					   res[13] = {"behemoth-biter",  	{{0.90, 0.0}, {1.00, 0.3}}}					   			   
...
data.raw["unit-spawner"]["bob-spitter-spawner"].result_units = (function()
                     local res = {}
                       ...
                       res[9] = {"big-spitter-Mk2",	 	{{0.75, 0.0}, {1.00, 0.1}}}
					   res[10] = {"big-spitter-Mk3", 	{{0.85, 0.0}, {1.00, 0.1}}}
					    			                       					   
					   res[11] = {"bob-bigger-spitter", {{0.70, 0.0}, {0.09, 0.3}}}
					   res[12] = {"bob-biggest-spitter",{{0.90, 0.0}, {1.00, 0.3}}}
					   res[13] = {"bob-poison-spitter",	{{0.90, 0.0}, {1.00, 0.2}}}
					   
					   res[14] = {"behemoth-spitter",  	{{0.95, 0.0}, {1.00, 0.3}}}				
